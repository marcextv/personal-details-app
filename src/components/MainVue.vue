          ...
          <v-container grid-list-md>
            <v-layout wrap>
              ...
              <v-text-field label="E-mail"
                 v-model="dialogEmail" autofocus required>
                 </v-text-field>
              </v-flex>
              <v-flex xs12 sm6>
              <v-text-field label="Personal ID"
                 v-model="dialogCI" autofocus required>
                 </v-text-field>
              </v-flex>
            </v-layout>
          </v-container>
  ...
  export default {
    ...
    methods: {
      showDialog(show, item) {
       ...
       this.dialogFirstName = (item || {}).name;
       this.dialogLastName = (item || {}).lastName;
       this.dialogEmail = (item || {}).email;
       this.dialogCI = (item || {}).ci;
      },
      save() {
        let data = {
          name: this.dialogFirstName,
